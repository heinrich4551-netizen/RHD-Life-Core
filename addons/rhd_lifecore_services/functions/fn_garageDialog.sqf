...
private _d=uiNamespace getVariable ["RHD_GarageDialog",displayNull];
if (_index >= 0) exitWith {private _plate=(_d displayCtrl 8891) lbData _index; [_plate] remoteExecCall ["RHD_fnc_garageRetrieveServer",2]; true};
createDialog "RHD_GarageDialog";
_d=uiNamespace getVariable ["RHD_GarageDialog",displayNull];
private _l=_d displayCtrl 8891;
lbClear _l;
{
